...
var pouchService = /** @class */ (function () {
    ...
    pouchService.prototype.saveCredential = function (credential) {
        var context = this;
        var promise = context.credentialdb.put({ _id: credential.title, username: credential.username, password: credential.password }).then().catch();
        return promise;
    };
